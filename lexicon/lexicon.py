LEXICON_RU: dict[str, str] = {
    '/start': 'привет!✌\nЯ Bun_bot! Моя задача помочь тебе в работе со Сликами Бай.\n'
              'Здесь ты получишь:\n'
              '✅Варианты взаимодействий со Cливками\n'
              '✅Стоимость\n'
              '✅Статистику\n'
              '✅Примеры\n'
    ...
    ,
    '/description_slivki':
        'Сливки бай - это крупнейший маркетплэйс скидок в РБ.\n'
        ...
        '✅11.000+ партнеров\n'
        '✅15 Instagram-аккаунтов в Беларуси, 30 блогеров\n'
        '✅40 городов Беларуси\n\n'
        '👨‍👨‍👧‍👦Аудитория Сливки Бай - активне население Беларуси с яркой жизненной позицией.\n'
        '👱‍♀️Женщины - 63%,\n'
        '👨‍🦰Мужчины - 37%\n'
        '25-44 года - 53%\n'
        '💰Средний доход + - 68%\n',
...
LEXICON_PRICE: dict[str, str] = {
    ...
    'manager': 'Менедж🤓р',
    'photo_telejka1': 'AgACAgIAAxkBAAIP2WVQxOIaFa6qv_9ZXNskuJuUziS9AAI50DEbQAKASpxDUtjsDM_tAQADAgADcwADMwQ',
    ...
    'insta_info10': '<b>Розыгрыши в Instagram.</b>\n'
                   ...
                   '💵 Стоимость рзыгрыша 300 - 500 рублей.\n',
