...
LEXICON_RU: dict[str, str] = {
    '/start': 'привет!\nЯ Bun_bot! Моя задача помочь тебе в работе со Сликами Бай. '
              'Я покажу тебе варианты взаимодействий со Cливками, дам цены, статистику, покажу примеры,'
              'помогу связаться с личным менеджером.\n\n'
    ...
    ,
    '/description_slivki':
        'Сливки бай - это самый крупный маркетплэйс скидок в РБ.\n'
        'За 12 лет работы на рынке информационно-рекламных услуг, компания достигла следующего:\n\n'
