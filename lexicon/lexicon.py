LEXICON_RU: dict[str, str] = {
    '/start': 'привет!✌\nЯ Bun_bot😎! Моя задача помочь тебе в работе со Сликами Бай.\n\n'
              ...
              '✅Статистику.\n'
              '✅Примеры.\n\n'
              'Я помогу связаться с личным менеджером🤓.\n\n'
              'Если хочешь узнать какие команды доступны тебе, отправь команду /help\n'
              'Воспользуйся основным меню! Смотри ниже 👇👇👇.',
    ...
    '/help': 'Тебе доступны команды:\n'
             ...
             'Ты можешь воспользваться основным меню! Смотри ниже 👇👇👇.'
    ,
    '/description_slivki':
        '<b>Сливки бай - это крупнейший маркетплэйс скидок в РБ.</b>\n'
        '✅12 лет на рынке информационно-рекламных услуг.\n'
        '✅1 000 000+ пользователей на сайте в месяц.\n'
        '✅1 000 000+ установок приложения.\n'
        '✅756 000+ подписчиков в социальных медиа.\n'
        '✅11 000+ партнеров.\n'
        '✅15 Instagram-аккаунтов в Беларуси.\n'
        '✅30 блогеров в штате.\n'
        '✅40 городов Беларуси.\n\n'
        '👨‍👨‍👧‍👦Аудитория Сливки Бай - активное население Беларуси со седним доходом и с яркой жизненной позицией.\n'
    ,
    ...
    '/description': '😎Bun_bot - вертуальный специалит по качественному продвижению в компании Сливки бай.\n'
                    ...
                    ' ознакомит вас с основными вариантами размещения на Сливках, поможет связаться с меджером🤓 по продажам рекламных услуг.\n'
                    '😎Bun_bot является молодым ботом. Он будет развиваться Объем и качество, предоставляемой им информации, будут расти.'
    ,
