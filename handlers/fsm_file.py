...
from keyboards.inline.inline_connection_manager import get_inline_connection_manager, markup_yes_no
...
async def process_name_sent(message: Message, state: FSMContext):
    ...
    await message.answer(text='Напишите как мы можем с вами связаться и что вас интересует.')
